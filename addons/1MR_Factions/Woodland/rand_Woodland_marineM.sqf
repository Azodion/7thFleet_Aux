...
_randheadgear = ["TKE_UCMCHelm_7thMEFWdlM",1,"TKE_UCMCHelmClearClosed7thMEFWdlM",1,"TKE_UCMCHelmClearMask_7thMEFWdlM",1,"TKE_PatrolCapWdlB",0.1];
...
_randvest = ["TKE_UCMCArmour2_17thWdl",1,"TKE_UCMCArmour2_27thWdl",1,"TKE_UCMCArmour6_17thWdl",1]; 
