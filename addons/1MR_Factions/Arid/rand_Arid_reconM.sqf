...
_randheadgear = ["TKE_UCMCHelm_7thMEFAridM",1,"TKE_UCMCHelmClearClosed7thMEFAridM",1,"TKE_UCMCHelmClearMask_7thMEFAridM",1];
...
_randvest = ["TKE_UCMCArmour3_17thArid",1,"TKE_UCMCArmour3_27thArid",1,"TKE_UCMCArmour6_27thArid",1]; 
